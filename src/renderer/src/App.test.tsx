...
function makeOfficer(overrides: Partial<typeof window.officer> = {}): typeof window.officer {
  ...
  return {
    ...
    metaRefreshSource: vi.fn().mockResolvedValue(undefined),
    ...
    metaDeriveComp: vi.fn().mockResolvedValue(undefined as never),
    metaUpdatePlaybook: vi.fn().mockResolvedValue(null),
    generalIndexStats: vi.fn().mockResolvedValue(undefined as never),
    generalIndexSample: vi.fn().mockResolvedValue([]),
    generalIndexSearch: vi.fn().mockResolvedValue([]),
    memoryList: vi.fn().mockResolvedValue([]),
    memoryCreate: vi.fn().mockResolvedValue(undefined as never),
    memoryUpdate: vi.fn().mockResolvedValue(undefined as never),
    memoryDelete: vi.fn().mockResolvedValue(undefined),
    memoryPin: vi.fn().mockResolvedValue(undefined as never),
    memorySearch: vi.fn().mockResolvedValue([]),
    memoryReindex: vi.fn().mockResolvedValue(undefined as never),
    memoryFactsForEntity: vi.fn().mockResolvedValue([]),
    memoryIndexStats: vi.fn().mockResolvedValue(undefined as never),
    ...
    rosterLinkDelete: vi.fn().mockResolvedValue(undefined as never),
    rosterAnnotationsList: vi.fn().mockResolvedValue([]),
    rosterAnnotationUpsert: vi.fn().mockResolvedValue(undefined as never),
    rosterAnnotationDelete: vi.fn().mockResolvedValue(undefined as never),
    ollamaGetStatus: vi.fn().mockResolvedValue(undefined as never),
    ollamaDetectHardware: vi.fn().mockResolvedValue(undefined as never),
    ollamaInstall: vi.fn().mockResolvedValue(undefined as never),
    ollamaUninstall: vi.fn().mockResolvedValue(undefined as never),
    ollamaPullModel: vi.fn().mockResolvedValue(undefined as never),
    onOllamaProgress: vi.fn().mockImplementation(noop),
    wikiIndexStats: vi.fn().mockResolvedValue({ total: 0, byMode: {}, bySource: {}, lastIndexedAt: null }),
    wikiIndexSample: vi.fn().mockResolvedValue([]),
    wikiIndexSearch: vi.fn().mockResolvedValue([]),
    ...
    axilogStatus: vi.fn().mockResolvedValue({ dir: null, dirExists: false, available: true, reason: null }),
